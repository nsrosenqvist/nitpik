...
2. **Performance**: Unnecessary re-renders, missing memoization, large bundle imports that should be lazy-loaded, layout thrashing, unoptimized images
...
5. **Browser Compatibility**: APIs that need polyfills, CSS features with limited support, inconsistent behavior across engines
